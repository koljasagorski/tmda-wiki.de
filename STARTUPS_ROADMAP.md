...
**Jede** Startup-Idee aus den Folgen 1-63 hat jetzt eine eigene Page — auch die Spaß-/Low-Score- und ungewerteten Ideen. Jede mit komplett individuellem Design-Stil (kein Stil doppelt). Alle Pages haben oben links einen einheitlichen „← Wiki"-Zurück-Button (injiziert via `scripts/inject-back-button.js`, idempotent).

### 20/24

- [x] **Ich bin kein Fan von** · Folge 63 · 20/24 · Punk-Fanzine / Cut-and-Paste Zine-Ästhetik (Special Elite + Space Mono, Schwarz/Weiß/Rot, Ransom-Note-Typografie, Shirt-Grid-Preview, crosshatch Dekoration)
